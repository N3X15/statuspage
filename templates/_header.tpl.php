...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr"> 
	<head>
		...
		<?if(!empty($_SESSION['auth']['id'])):?><script type="text/javascript" src="js/jquery.jeditable.mini.js"></script><?endif;?>
	...
	<body>
		<div id="header">
			<div class="wrapper">
				...
				<h1><a href="index.php"><img src="images/logo.gif" alt="{$pagetitle}" /></a></h1>
				<?else:?>
